tic
% define  folder
Folder = fullfile('C:\Users\jayna\Desktop\New folder\deep\DLProject\data', 'CAltech101'); 
...
%Give labels to training and testing features
 ...
 writematrix(new_F_train,'new_F_train.csv');
 writematrix(new_F_test,'new_F_test.csv');
 writematrix(train_labels,'train_labels.csv');
 writematrix(test_labels,'test_labels.csv');
