tic
% define  folder
Folder = fullfile('C:\Users\Neel\Desktop\Object_recognition_deep_learning-master\data', 'caltech256'); 
...
%Give labels to training and testing features
 ...
 writematrix(new_F_train,'Cnew_F_train.csv');
 writematrix(new_F_test,'Cnew_F_test.csv');
 writematrix(train_labels,'Ctrain_labels.csv');
 writematrix(test_labels,'Ctest_labels.csv');
